...
export const proyectos = [
  {
    ...
    descripcion: "Análisis del éxito de la serie Friends, limpieza y visualización usando Power BI y DAX",
    imagen: Friends.src,
  ...
  },
  {
    ...
    descripcion: "Proyecto base de datos de un videoclub utilizando SQL",
    imagen: Sakila.src,
    tecnologias: ["SQL"],
  ...
  },
  {
    ...
    descripcion: "Extracción y análisis de datos musicales (2000 - 2005) con Python, SQL y APIs de Spotify y Last.fm.",
  ...
  },
  {
    ...
    descripcion: "Análisis éxito de la serie The Simpons realizando un EDA en python y visualización en Tableau",
